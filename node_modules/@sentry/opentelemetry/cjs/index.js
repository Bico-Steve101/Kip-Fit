  ...
  class OpenTelemetryClient extends ClientClass  {
     ...
     */
     async flush(timeout) {
      ...
      const spanProcessor = _optionalChain$9([provider, 'optionalAccess', _ => _.activeSpanProcessor]);
...
function getSamplingDecision(spanContext) {
  ...
  if (_optionalChain$8([dsc, 'optionalAccess', _ => _.sampled]) === 'true') {
    return true;
  }
  if (_optionalChain$8([dsc, 'optionalAccess', _2 => _2.sampled]) === 'false') {
    return false;
  }
...
function getDynamicSamplingContextFromSpan(span) {
  ...
  const traceStateDsc = _optionalChain$7([traceState, 'optionalAccess', _ => _.get, 'call', _2 => _2(SENTRY_TRACE_STATE_DSC)]);
